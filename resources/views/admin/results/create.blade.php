            ...
            <div class="card shadow">
                <div class="card-header py-3 bg-white">
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="m-0 font-weight-bold text-primary">ထွက်ဂဏန်းအသစ်ထည့်ရန်</h6>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('draw_time') is-invalid @enderror" 
                                    id="draw_time" name="draw_time" required>
                                @error('draw_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div id="numbersContainer">
                                <div class="number-field mb-2">
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('numbers.0') is-invalid @enderror" 
                                            name="numbers[]" required>
                                        <button type="button" class="btn btn-outline-danger remove-number" disabled>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('prize_amount') is-invalid @enderror" 
                                    id="prize_amount" name="prize_amount" min="0" step="1" required>
